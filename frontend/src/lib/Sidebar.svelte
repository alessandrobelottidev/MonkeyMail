...
<div class={"min-h-screen w-[3.30rem] overflow-hidden border-r bg-white fixed left-0 top-0 duration-300".concat(" ", (sidebar) ? 'hover:w-56 hover:shadow-lg' : '')}>
    <div class="flex h-screen flex-col justify-between pt-2 pb-2">
        <div>
            ...
            <ul class="mt-6 space-y-2 tracking-wide">
                <Link to="/dashboard" on:click={() => handleActive("dashboard")}>
                ...
                <Link to="/contacts" on:click={() => handleActive("contacts")}>
                    <SidebarItem active={active} name="contacts">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                        </svg>
                        <span>Contacts</span>
                    </SidebarItem>
                </Link>
                <Link to="/groups" on:click={() => handleActive("groups")}>
                ...
                <Link to="/forms" on:click={() => handleActive("forms")}>
                ...
                <Link to="/emails" on:click={() => handleActive("emails")}>
                ...
                <Link to="/send-email" on:click={() => handleActive("send-email")}>
        ...
        <ul class="min-w-max">
            <Link to="/profile" on:click={() => handleActive("profile")}>
